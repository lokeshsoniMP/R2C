...
sealed class DashBoardNavigationRoute(val route: String) {
    ...
    object PackagingSuperVisorCreateGINScreen : DashBoardNavigationRoute("packaging_supervisor_create_gin_screen")
    object StoreInChargeDashBoardScreen : DashBoardNavigationRoute("storeincharge_dashboard_screen")
    object StoreRequisitionDashBoardScreen : DashBoardNavigationRoute("store_requisition_dashboard_screen")
    ...
    object GatePassTTGoodsDetailsScreen: DashBoardNavigationRoute("gateKeeper_tt_goods_screen")
    ...
    object AssignSuperviser: DashBoardNavigationRoute("Assign_superviser_screen")
}