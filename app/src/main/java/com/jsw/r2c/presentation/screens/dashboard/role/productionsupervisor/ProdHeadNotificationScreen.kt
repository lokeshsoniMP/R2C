package com.jsw.r2c.presentation.screens.dashboard.role.productionsupervisor
...
@Composable
fun ProdHeadNotificationScreen(navController: NavController,
                    ...
                    items(5) { index ->
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .clickable {
                                    navController.navigate(DashBoardNavigationRoute.PackagingSuperVisorDashBoardScreen.route)
                                },
